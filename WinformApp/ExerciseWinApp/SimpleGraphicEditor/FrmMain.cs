...
namespace SimpleGraphicEditor
{
    ...
    public partial class FrmMain : Form
    {
        ...
        private void TlmSquare_Click(object sender, EventArgs e)
        {
        ...
        private void FrmMain_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            switch (this.mode)
            {
                ...
                case DrawMode.RECTANGLE:
                    g.DrawRectangle(this.eraser, new Rectangle(startP, new Size(prevP.X - startP.Y, prevP.Y - startP.Y)));
                    g.DrawRectangle(this.pen, new Rectangle(startP, new Size(currP.X - startP.Y, currP.Y - startP.Y)));
                    break;
                case DrawMode.CIRCLE:
                    g.DrawEllipse(this.eraser, new Rectangle(startP, new Size(prevP.X - startP.Y, prevP.Y - startP.Y)));
