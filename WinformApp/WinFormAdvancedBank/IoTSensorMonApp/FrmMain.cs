...
namespace IoTSensorMonApp
{
    public partial class FrmMain : Form
    {
        ...
        private string connString = "Data Source=127.0.0.1;Initial Catalog=IoTData;Persist Security Info=True;" +
        ...
        private void TxtSensorNum_TextChanged(object sender, EventArgs e)
        {
